...
import com.zucc.xwk_31401151.sharebookclient.ui.activity.AddBookDetailActivity;
...
public class AddBookListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AddBookListAdapter(Context context, List<BookInfoResponse> responses, int columns) {
...
//            ((BookListHolder) holder).tv_hots_num.setText(bookInfo.getRating().getAverage());
            ...
            ((BookListHolder) holder).itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(UIUtils.getContext(), AddBookDetailActivity.class);
                    intent.putExtras(b);
