                    ...
                    runOnUiThread(new Runnable() {
                                      ...
                                      public void run() {
                                          if (loginModel != null && loginModel.status == 1000 && loginModel.data != null) {
                                              ...
                                              SaveUserUtil.getInstance().saveUser(RegisterActivity.this, loginModel.data.user_id, loginModel.data.user, loginModel.data.token, loginModel.data.user_name,loginModel.data.phone);
